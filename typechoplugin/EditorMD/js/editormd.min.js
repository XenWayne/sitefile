	...
	if ("undefined" != typeof e) {
		...
		t.prototype = t.fn = {
			...
			init: function(i, o) {
				...
				"function" == typeof define && define.amd && ("undefined" != typeof katex && (t.$katex = katex), n.searchReplace && !n.readOnly && (t.loadCSS(n.path + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/addon/dialog/dialog"), t.loadCSS(n.path + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/addon/search/matchesonscrollbar"))),
			...
			loadQueues: function() {
				...
				r = function() {
					...
					function() {
						t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/underscore.min",
						function() { ! i.flowChart && i.sequenceDiagram ? t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/sequence-diagram.min",
							function() {
								e.loadedDisplay()
							}) : i.flowChart && !i.sequenceDiagram ? t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/flowchart.min",
							function() {
								t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/jquery.flowchart.min",
								function() {
									e.loadedDisplay()
								})
							}) : i.flowChart && i.sequenceDiagram && t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/flowchart.min",
							function() {
								t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/jquery.flowchart.min",
								function() {
									t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/sequence-diagram.min",
									function() {
										e.loadedDisplay()
									})
								})
				...
				return t.loadCSS(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/codemirror.min"),
				i.searchReplace && !i.readOnly && (t.loadCSS(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/addon/dialog/dialog"), t.loadCSS(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/addon/search/matchesonscrollbar")),
				i.codeFold && t.loadCSS(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/addon/fold/foldgutter"),
				t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/codemirror.min",
				function() {
					t.$CodeMirror = CodeMirror,
					t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/modes.min",
					function() {
						t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/addons.min",
						function() {
							return e.setCodeMirror(),
							"gfm" !== i.mode && "markdown" !== i.mode ? (e.loadedDisplay(), !1) : (e.setToolbar(), void t.loadScript(o + "marked.min",
							function() {
								t.$marked = marked,
								i.previewCodeHighlight ? t.loadScript(o + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/prettify.min",
								function() {
									r()
								}) : r()
							}))
			...
			setEditorTheme: function(e) {
				...
				"default" !== e && t.loadCSS(i.path + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/theme/" + i.editorTheme),
			...
			setCodeMirror: function() {
				var e = this.settings,
				i = this.editor;
				"default" !== e.editorTheme && t.loadCSS(e.path + "https://cdn.jsdelivr.net/gh/XenWayne/sitefile@master/typechoplugin/EditorMD/lib/codemirror/theme/" + e.editorTheme);
				var o = {
					mode: e.mode,
					theme: e.editorTheme,
					tabSize: e.tabSize,
		...
		t.emoji = {
			path: "//cdn.staticfile.org/emoji-cheat-sheet/1.0.0/",
			ext: ".png"
		},
		t.twemoji = {
			path: "//cdn.staticfile.org/twemoji/2.2.5/36x36/",
			ext: ".png"
		},
